...
public class ORBSLAMForDataSetActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (TextUtils.isEmpty(vocPath) || TextUtils.isEmpty(calibrationPath)) {
			...
			Log.e("information==========>",vocPath+" "+calibrationPath);
...
//        								}
        								...
        								try{
        								resultImg
        										.setPixels(resultInt, 0, w, 0, 0, w, h);}catch (Exception e){
											Log.e("INFO======>","No result int array");
										}
        								runOnUiThread(new Runnable() {
        									@Override
        									public void run() {
